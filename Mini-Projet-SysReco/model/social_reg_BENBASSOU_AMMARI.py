...
"""
Voir les fichiers utility.node2Vec.py et utility.main_node2vec.py pour l'implementation complete de la notion Node2Vec
"""
...
#from utility.main_node2vec import read_graph
...
# step 1 : run main_node2vec.py to generate embeddings (csv & txt)

    def get_rowcsv(self, user_node, path):
    ...
    def get_sim_node2vec(self , u, k):
            
            embd_u = self.get_rowcsv(u,"embeddings/embeddings.csv")
            embd_v = self.get_rowcsv(k,"embeddings/embeddings.csv")
